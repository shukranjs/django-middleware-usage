...
SECRET_KEY = "django-insecure-br^*m!d(&(vot%o0cf98p*ii997^!b0v8)jy+&3d=tkcop7ob("
...
MIDDLEWARE = [
    ...
    # custom middlewares
    "myapp.middleware.RequestResponseLoggerMiddleware",
    ...
    "myapp.middleware.IPWhitelistMiddleware",
    "myapp.middleware.CompressionMiddleware",
